...
public class AISpecialSkillsUsage {
	public static SpecialSkill getBestSpecialSkill(Player player, Enemy enemy, boolean enemyBegin) {
		return null;
	}
	// public static SpecialSkill getBestSpecialSkill(Player player, Enemy
	// enemy, boolean enemyBegin) {
	...
	// return findSkillIfNoCandidates(enemyActiveSkills, player, enemy,
	// enemyBegin);
	// }
	...
	// continue;
	// if (SpecialSkillsMap.isSpecialSkillEqualToName(activeSkill.getClass(), s)
	// && activeSkill.canUse()) {
	// return findInterceptAndReturnCorrectSkill(enemy, player, activeSkill,
	// enemyActiveSkills);
	// }
	// }
	// }
	...
	// private static String findInterceptAndReturnCorrectSkill(Enemy enemy,
	// Player pl, SpecialSkill specialSkill, List<SpecialSkill> activeSkills) {
	...
	// }
	//
	// private static String findInterceptSkill(Player player, Enemy enemy,
	// String interceptSkill, List<SpecialSkill> activeSkills) {
	...
	// }
	//
	// public static String findSkillIfNoCandidates(List<SpecialSkill>
	// sortedSkills, Player player, final Enemy enemy, boolean enemyBegin) {
	...
	// if (SpecialSkillsMap.isSpecialSkillEqualToName(plSkill.getClass(), a) &&
	// plSkill.canUse())
	// continue;
	// }
	//
	...
	// continue;
	// return findInterceptAndReturnCorrectSkill(enemy, player, s,
	// sortedSkills);
	// }
	// return null;
	// }
	//
	// private static boolean canUseSkill(SpecialSkill skill, Player player,
	// Enemy enemy) {
	// Stats c = enemy.getCurrentStats();
	// Stats b = enemy.getStats();
	// SpecialSkill plSkill = player.getSpecialSkill();
	...
	// }
	// }
	// if (skill.doSomething(player, enemy) &&
	// !enemy.getEnemyLevel().equals(EnemyLevel.CREATURE))
	// return true;
	// int missingHP = b.getHealth() - c.getHealth();
	// boolean skip = (skill.getType() != null && skill.getType().equals(HEALTH)
	// && !skill.isDebuff() && skill.getValue(enemy) > missingHP) &&
	// !enemy.getEnemyLevel().equals(EnemyLevel.CREATURE);
	// return !skip;
	// }
	//
	// public static List<SpecialSkill> separateLimitedSkills(List<SpecialSkill>
	// sortedSkills) {
	...
	// }
	//
	// private static List<SpecialSkill> sortSkills(Player player, final Enemy
	// enemy) {
	...
	//
	// List<SpecialSkill> sortedByAspects = new
	// ArrayList<>(enemy.getActiveSkills());
	// Collections.sort(sortedByAspects, new Comparator<SpecialSkill>() {
	// @Override
	// public int compare(SpecialSkill arg0, SpecialSkill arg1) {
	// if (enemy.getEnemyLevel().equals(EnemyLevel.BOSS)) {
	// if
	// (arg0.getBestInterceptSkills().contains(SpecialSkillsMap.getSkillId(arg1.getClass())))
	// {
	// return 1;
	// }
	// if
	// (arg1.getBestInterceptSkills().contains(SpecialSkillsMap.getSkillId(arg0.getClass())))
	// {
	// return -1;
	// }
	// }
	...
	// return -1;
	// if (arg0.getType() != null && arg0.getType().equals(HEALTH) &&
	// !arg0.isDebuff()) {
	...
	// }
	//
	// private static List<String> getBestCandidateSkills(List<SpecialSkill>
	// sortedSkills, Player player) {
	// SpecialSkill plSkill = player.getSpecialSkill();
	...
	// for (SpecialSkill skill : sortedSkills) {
	// if (skill.canUse() &&
	// hasBestInterceptSkillsUsed(skill.getBestInterceptSkills(), sortedSkills)
	// && SpecialSkillsMap.getSkillId(skill.getClass()).equals(against))
	...
	// }
	//
	// private static boolean hasBestInterceptSkillsUsed(List<String>
	// interceptSkills, List<SpecialSkill> activeSkills) {
	// for (String is : interceptSkills) {
	// for (SpecialSkill s : activeSkills) {
	// if (SpecialSkillsMap.isSpecialSkillEqualToName(s.getClass(), is) &&
	// s.getCountOfUsed() == 0)
	// return false;
	// }
	// }
